...
public class ListScrollTest
{
    ...
    private Scroll<String> nullList; // null
    ...
    @Test(expected = IllegalStateException.class)
    public void testDeleteWhenRightListIsEmpty()
    {
        // Setup
        ab_cd_6.delete();
        ab_cd_6.delete();
    ...
    @Test(expected = IllegalStateException.class)
    public void testAdvanceWhenRightListIsEmpty()
    {
        // Setup
        ab_cd_6.delete();
        ab_cd_6.delete();
    ...
    @Test(expected = IllegalStateException.class)
    public void testRetreatWhenLeftListIsEmpty()
    {
        // Setup
        ab_cd_6.reset();
    ...
    /* --- TESTS FOR ADVANCE TO END METHOD --- */
    ...
    @Test(expected = IllegalStateException.class)
    public void testSwapRightsThatExceedsCapacityWithEmptyList()
    {
        // Setup
        w_xyz_8.insert("A");
    ...
    public void testNewInstanceForEmpty3AfterInsertingElement()
    {
        ...
        Scroll<String> newListScroll = empty_3.newInstance(); // ACTION

        assertEquals(3, newListScroll.capacity());
        assertTrue(newListScroll.leftLength() == 0 && newListScroll.rightLength() == 0);
    }
}